...
Make sure you follow special instructions. These may be ordered by the prescriber, or found on the supplemental labels on the packaging. Some examples:

"Take medication on an empty stomach "Take with food"

"Hold for heart rate (pulse) less than 60" "Do not give if client is having diarrhea"

"Pop" the medication into the medication cup - or, if pouring a pill from a pill bottle, pour from the bottle into the lid, then into the med cup. Do not touch the medication with your fingers.

Crush medications if required, and mix with whatever substance the client prefers (applesauce, pudding, ice cream), unless the prescriber has given a specific order. Check supplemental labels to make sure you are not mixing the medication with a food it should not be given with.

## Liquid Oral Medications

Shake the bottle before pouring - many medications settle. Remove the cap and put it down with the lip facing up to avoid contamination.

Use the dosing cup that comes with the medication, if possible. Do not use household spoons to measure medications!

Make sure the dosing cup is on a level surface for accurate measuring.

Pour away from the label to ensure it remains legible (no drips).

Wipe the lid and neck of the bottle with a damp paper towel before storing.

With the cup at eye level, read the amount of medication at the bottom of the curve the liquid forms in the cup.

If supervising self-administration, you may need to help the client open the bottle, check the measurement, close and clean the bottle. You might need to help pour.

Always give liquid cough medications last to coat the throat.
